      ...
      <header className="fixed top-0 left-0 right-0 h-16 bg-white border-b border-gray-200 z-50 shadow-sm">
        <div className="flex items-center justify-between h-full px-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Back to Map Link - Desktop */}
            <Link
              href="/"
              className="hidden md:flex items-center gap-2 px-3 py-2 text-sm text-gray-700 hover:text-green-600 hover:bg-green-50 rounded-lg transition"
            >
